...
function bool InternalOnClick(GUIComponent C)
{
    switch(C)
    {
        case bu_GameTypeMenu:  PlayerOwner().ClientReplaceMenu("UTCompv17Beta4SRC.UTComp_Menu_Voting_GameType"); break;
        case bu_MapChangeMenu:  PlayerOwner().ClientReplaceMenu("UTCompv17Beta4SRC.UTComp_Menu_Voting_Map");  break;
        case bu_UTComp_SettingsMenu:  PlayerOwner().ClientReplaceMenu("UTCompv17Beta4SRC.UTComp_Menu_Voting_Settings");    break;
    }
    Blehz();
...
defaultproperties
{
     ...
     End Object
     bu_GameTypeMenu=GUIButton'UTCompv17Beta4SRC.UTComp_Menu_Voting.GameTypeButton'
     ...
     End Object
     bu_MapChangeMenu=GUIButton'UTCompv17Beta4SRC.UTComp_Menu_Voting.MapChangeButton'
     ...
     End Object
     bu_UTComp_SettingsMenu=GUIButton'UTCompv17Beta4SRC.UTComp_Menu_Voting.UTComp_SettingsButton'
